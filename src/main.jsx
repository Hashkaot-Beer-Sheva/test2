        ...
        <header>
          ...
          <div className="actions top-search-wrap">
            ...
            <div className="cloud-source-loaders" title="Load each cloud source independently">
              {['unified', 'master', 'coordinates', 'renters', 'transactions', 'occupancy'].map((source) => (
